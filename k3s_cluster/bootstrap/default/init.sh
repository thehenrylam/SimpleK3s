...
# Set up log file
DEFAULT_LOG_FILE="${SCRIPT_PATH}/simplek3s-init_$(date +'%Y%m%d%H%M%S%3N').log"
...
$SCRIPT_PATH/01_install_packages.sh || exit 1

# Setup the swapfile
$SCRIPT_PATH/02_setup_swapfile.sh "$SWAPFILE_ALLOC_AMT" || exit 1
